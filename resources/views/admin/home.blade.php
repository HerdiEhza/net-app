    ...
    <div id="page">
        <div class="space-y-2">
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <div
                    class="h-full p-6 space-y-6 bg-white bg-opacity-50 border rounded-lg shadow-2xl group sm:p-8 border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 shadow-gray-600/10">
                ...
                <div
                    class="h-full p-6 bg-white bg-opacity-50 border rounded-lg shadow-2xl group sm:p-8 border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 shadow-gray-600/10">
