        ...
        <div class="px-6 pt-6 2xl:container">
            <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                <div class="md:col-span-2 lg:col-span-1">
                    <div
                        class="h-full p-6 space-y-6 bg-white bg-opacity-50 border shadow-2xl group sm:p-8 rounded-3xl border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 shadow-gray-600/10">
                        ...
                        <div>
                            <h5 class="text-xl text-center text-gray-600 dark:text-gray-300">Global Activities</h5>
                ...
                <div>
                    <div
                        class="h-full p-6 bg-white bg-opacity-50 border shadow-2xl group sm:p-8 rounded-3xl border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 shadow-gray-600/10">
                        ...
                        <table class="w-full mt-6 -mb-2 text-gray-600">
                            <tbody>
                ...
                <div>
                    <div
                        class="p-6 bg-white bg-opacity-50 border shadow-2xl group sm:p-8 rounded-3xl border-gray-200/50 dark:shadow-none dark:border-gray-700 dark:bg-gray-800 shadow-gray-600/10 lg:h-full">
                        ...
                        <div class="mt-6">
                            <h5 class="text-xl text-center text-gray-700 dark:text-gray-300">Ask to customize</h5>
                            <div class="flex justify-center gap-4 mt-2">
                        ...
                        <table class="w-full mt-6 -mb-2 text-gray-600 dark:text-gray-300">
                            <tbody>
                                <tr>
                                    <td class="py-2">Tailored ui</td>
                                    <td class="text-gray-500">896</td>
