...
<body>
    <div class="flex h-screen overflow-hidden text-sm text-gray-600 bg-gray-100 dark:bg-gray-900 dark:text-white">
        <div class="flex-col flex-shrink-0 hidden w-20 bg-white border-r border-gray-200 dark:bg-gray-900 dark:border-gray-800 sm:flex">
          <div class="flex items-center justify-center h-16 text-blue-500">
          ...
          <div class="flex flex-col flex-grow mx-auto mt-4 space-y-4 text-gray-400">
            <button class="flex items-center justify-center w-12 h-10 rounded-md dark:text-gray-500">
            ...
            <button class="flex items-center justify-center w-12 h-10 text-blue-500 bg-blue-100 rounded-md dark:bg-gray-700 dark:text-white">
              <svg viewBox="0 0 24 24" class="h-5" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="flex flex-col flex-grow h-full overflow-hidden">
          <div class="hidden w-full h-16 px-10 border-b border-gray-200 lg:flex dark:border-gray-800">
            <div class="flex h-full text-gray-600 dark:text-gray-400">
              <a href="#" class="inline-flex items-center h-full mr-8 border-b-2 border-transparent cursor-pointer">Company</a>
              <a href="#" class="inline-flex items-center h-full mr-8 text-blue-500 border-b-2 border-blue-500 cursor-pointer dark:text-white dark:border-white">Users</a>
              <a href="#" class="inline-flex items-center h-full mr-8 border-b-2 border-transparent cursor-pointer">Expense Centres</a>
              <a href="#" class="inline-flex items-center h-full border-b-2 border-transparent cursor-pointer">Currency Exchange</a>
            </div>
            <div class="flex items-center ml-auto space-x-7">
              <button class="h-8 px-3 text-white bg-blue-500 rounded-md shadow">Deposit</button>
      
              <button class="flex items-center">
                <span class="relative flex-shrink-0">
                  <img class="rounded-full w-7 h-7" src="https://images.unsplash.com/photo-1521587765099-8835e7201186?ixlib=rb-1.2.1&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&ixid=eyJhcHBfaWQiOjE3Nzg0fQ" alt="profile" />
                ...
                <svg viewBox="0 0 24 24" class="flex-shrink-0 w-4 ml-1" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
          ...
          <div class="flex flex-grow overflow-x-hidden">
            <div class="flex-shrink-0 hidden w-48 h-full p-5 overflow-y-auto border-r border-gray-200 xl:w-72 dark:border-gray-800 lg:block">
              <div class="text-xs tracking-wider text-gray-400">USERS</div>
              <div class="relative mt-2">
                <input type="text" class="w-full pl-8 text-sm bg-transparent border border-gray-300 rounded-md h-9 dark:border-gray-700 dark:text-white" placeholder="Search" />
              ...
              <div class="mt-3 space-y-4">
                <button class="flex flex-col w-full p-3 bg-white rounded-md shadow dark:bg-gray-800">
                  <div class="flex flex-col items-center w-full pb-2 mb-2 font-medium text-gray-900 border-gray-200 border-opacity-75 xl:flex-row dark:text-white xl:border-b dark:border-gray-700">
                    <img src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-0.3.5&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&s=046c29138c1335ef8edee7daf521ba50" class="mr-2 rounded-full w-7 h-7" alt="profile" />
                    Kathyrn Murphy
                  </div>
                  <div class="flex items-center w-full">
                    <div class="px-2 py-1 text-xs leading-none text-blue-500 bg-blue-100 rounded-md dark:bg-gray-900">Design</div>
                    <div class="ml-auto text-xs text-gray-500">$1,902.00</div>
                  </div>
                </button>
                <button class="relative flex flex-col w-full p-3 bg-white rounded-md shadow-lg dark:bg-gray-800 ring-2 ring-blue-500 focus:outline-none">
                  <div class="flex flex-col items-center w-full pb-2 mb-2 font-medium text-gray-900 border-gray-200 border-opacity-75 xl:flex-row dark:text-white xl:border-b dark:border-gray-700">
                    <img src="https://assets.codepen.io/344846/internal/avatars/users/default.png?fit=crop&format=auto&height=512&version=1582611188&width=512" class="mr-2 rounded-full w-7 h-7" alt="profile" />
                    Mert Cukuren
                  </div>
                  <div class="flex items-center w-full">
                    <div class="px-2 py-1 text-xs leading-none text-green-600 bg-green-100 rounded-md dark:bg-gray-900">Sales</div>
                    <div class="ml-auto text-xs text-gray-500">$2,794.00</div>
                  </div>
                </button>
                <button class="flex flex-col w-full p-3 bg-white rounded-md shadow dark:bg-gray-800">
                  <div class="flex flex-col items-center w-full pb-2 mb-2 font-medium text-gray-900 border-gray-200 border-opacity-75 xl:flex-row dark:text-white xl:border-b dark:border-gray-700">
                    <img src="https://images.unsplash.com/photo-1541647376583-8934aaf3448a?ixlib=rb-1.2.1&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&ixid=eyJhcHBfaWQiOjE3Nzg0fQ" class="mr-2 rounded-full w-7 h-7" alt="profile" />
                    Albert Flores
                  </div>
                  <div class="flex items-center w-full">
                    <div class="px-2 py-1 text-xs leading-none text-yellow-600 bg-yellow-100 rounded-md dark:bg-gray-900">Marketing</div>
                    <div class="ml-auto text-xs text-gray-400">$0.00</div>
                  </div>
                </button>
                <button class="flex flex-col w-full p-3 bg-white rounded-md shadow dark:bg-gray-800">
                  <div class="flex flex-col items-center w-full pb-2 mb-2 font-medium text-gray-900 border-gray-200 border-opacity-75 xl:flex-row dark:text-white xl:border-b dark:border-gray-700">
                    <img src="https://images.unsplash.com/photo-1519699047748-de8e457a634e?ixlib=rb-1.2.1&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&ixid=eyJhcHBfaWQiOjE3Nzg0fQ" class="mr-2 rounded-full w-7 h-7" alt="profile" />
                    Jane Cooper
                  </div>
                  <div class="flex items-center w-full">
                    <div class="px-2 py-1 text-xs leading-none text-blue-500 bg-blue-100 rounded-md dark:bg-gray-900">Design</div>
                ...
                <button class="flex flex-col w-full p-3 bg-white rounded-md shadow dark:bg-gray-800">
                  <div class="flex flex-col items-center w-full pb-2 mb-2 font-medium text-gray-900 border-gray-200 border-opacity-75 xl:flex-row dark:text-white xl:border-b dark:border-gray-700">
                    <img src="https://images.unsplash.com/photo-1507120878965-54b2d3939100?ixlib=rb-0.3.5&q=80&fm=jpg&crop=faces&fit=crop&h=200&w=200&s=99fbace66d1bfa48c9c6dc8afcac3aab" class="mr-2 rounded-full w-7 h-7" alt="profile" />
                    Ronald Richards
                  </div>
                  <div class="flex items-center w-full">
                    <div class="px-2 py-1 text-xs leading-none text-green-600 bg-green-100 rounded-md dark:bg-gray-900">Sales</div>
            ...
            <div class="flex-grow overflow-y-auto bg-white dark:bg-gray-900">
              <div class="sticky top-0 flex flex-col w-full px-4 pt-4 bg-white border-b border-gray-200 sm:px-7 sm:pt-7 dark:bg-gray-900 dark:text-white dark:border-gray-800">
                <div class="flex items-center w-full">
                  ...
                  <div class="items-center justify-end hidden ml-auto sm:flex">
                    <div class="text-right">
                      <div class="text-xs text-gray-400 dark:text-gray-400">Account balance:</div>
                      <div class="text-lg text-gray-900 dark:text-white">$2,794.00</div>
                    </div>
                    <button class="flex items-center justify-center w-8 h-8 ml-4 text-gray-400 border border-gray-200 rounded-full shadow dark:text-gray-400 dark:border-gray-700">
              ...
              <div class="p-4 sm:p-7">
                <div class="flex items-center w-full mb-7">
                  ...
                  <div class="items-center hidden ml-auto text-xs text-gray-500 sm:inline-flex">
                    <span class="mr-3">Page 2 of 4</span>
                    <button class="inline-flex items-center justify-center w-8 h-8 py-0 mr-2 leading-none text-gray-400 border border-gray-200 rounded-md shadow dark:border-gray-800">
                    ...
                    <button class="inline-flex items-center justify-center w-8 h-8 py-0 leading-none text-gray-400 border border-gray-200 rounded-md shadow dark:border-gray-800">
                      <svg class="w-4" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                ...
                <table class="w-full text-left">
                  <thead>
                    <tr class="text-gray-400">
                      <th class="px-3 pt-0 pb-3 font-normal border-b border-gray-200 dark:border-gray-800">Type</th>
                      <th class="px-3 pt-0 pb-3 font-normal border-b border-gray-200 dark:border-gray-800">Where</th>
                      <th class="hidden px-3 pt-0 pb-3 font-normal border-b border-gray-200 dark:border-gray-800 md:table-cell">Description</th>
                      <th class="px-3 pt-0 pb-3 font-normal border-b border-gray-200 dark:border-gray-800">Amount</th>
                      <th class="px-3 pt-0 pb-3 font-normal text-white border-b border-gray-200 dark:border-gray-800 sm:text-gray-400">Date</th>
                    </tr>
                  </thead>
                  <tbody class="text-gray-600 dark:text-gray-100">
                    <tr>
                      <td class="px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800">
                      ...
                      <td class="hidden px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800 md:table-cell">Subscription renewal</td>
                      <td class="px-1 py-2 text-red-500 border-b border-gray-200 sm:p-3 dark:border-gray-800">- $120.00</td>
                      <td class="px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800">
                        <div class="flex items-center">
                          <div class="flex-col hidden sm:flex">
                            24.12.2020
                            <div class="text-xs text-gray-400">11:16 AM</div>
                          </div>
                          <button class="inline-flex items-center justify-center w-8 h-8 ml-auto text-gray-400">
                    ...
                    <tr>
                      ...
                      <td class="hidden px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800 md:table-cell">Subscription renewal</td>
                      <td class="px-1 py-2 text-red-500 border-b border-gray-200 sm:p-3 dark:border-gray-800">- $9.99</td>
                      <td class="px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800">
                        <div class="flex items-center">
                          <div class="flex-col hidden sm:flex">
                            24.12.2020
                            <div class="text-xs text-gray-400">07:16 AM</div>
                          </div>
                          <button class="inline-flex items-center justify-center w-8 h-8 ml-auto text-gray-400">
                            <svg viewBox="0 0 24 24" class="w-5" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                              <circle cx="12" cy="12" r="1"></circle>
                    ...
                    <tr>
                      ...
                      <td class="hidden px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800 md:table-cell">Macbook Pro 13"</td>
                      <td class="px-1 py-2 text-red-500 border-b border-gray-200 sm:p-3 dark:border-gray-800">- $1.499.99</td>
                      <td class="px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800">
                        <div class="flex items-center">
                          <div class="flex-col hidden sm:flex">
                            24.12.2020
                            <div class="text-xs text-gray-400">11:03 AM</div>
                          </div>
                          <button class="inline-flex items-center justify-center w-8 h-8 ml-auto text-gray-400">
                            <svg viewBox="0 0 24 24" class="w-5" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                              <circle cx="12" cy="12" r="1"></circle>
                    ...
                    <tr>
                      ...
                      <td class="hidden px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800 md:table-cell">Invoice No: 37401</td>
                      <td class="px-1 py-2 text-green-500 border-b border-gray-200 sm:p-3 dark:border-gray-800">+ $60.00</td>
                      <td class="px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800">
                        <div class="flex items-center">
                          <div class="flex-col hidden sm:flex">
                            13.11.2020
                            <div class="text-xs text-gray-400">09:45 AM</div>
                          </div>
                          <button class="inline-flex items-center justify-center w-8 h-8 ml-auto text-gray-400">
                            <svg viewBox="0 0 24 24" class="w-5" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                              <circle cx="12" cy="12" r="1"></circle>
                    ...
                    <tr>
                      ...
                      <td class="hidden px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800 md:table-cell">Product purchased</td>
                      <td class="px-1 py-2 text-red-500 border-b border-gray-200 sm:p-3 dark:border-gray-800">- $49.99</td>
                      <td class="px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800">
                        <div class="flex items-center">
                          <div class="flex-col hidden sm:flex">
                            10.03.2020
                            <div class="text-xs text-gray-400">10:29 AM</div>
                          </div>
                          <button class="inline-flex items-center justify-center w-8 h-8 ml-auto text-gray-400">
                            <svg viewBox="0 0 24 24" class="w-5" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                              <circle cx="12" cy="12" r="1"></circle>
                    ...
                    <tr>
                      ...
                      <td class="hidden px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800 md:table-cell">Subscription renewal</td>
                      <td class="px-1 py-2 text-red-500 border-b border-gray-200 sm:p-3 dark:border-gray-800">- $5.99</td>
                      <td class="px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800">
                        <div class="flex items-center">
                          <div class="flex-col hidden sm:flex">
                            02.04.2020
                    ...
                    <tr>
                      ...
                      <td class="hidden px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800 md:table-cell">PlayStation 5</td>
                      <td class="px-1 py-2 text-red-500 border-b border-gray-200 sm:p-3 dark:border-gray-800">- $399.99</td>
                      <td class="px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800">
                        <div class="flex items-center">
                          <div class="flex-col hidden sm:flex">
                            08.09.2020
                    ...
                    <tr>
                      ...
                      <td class="hidden px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800 md:table-cell">Invoice No: 12993</td>
                      <td class="px-1 py-2 text-green-500 border-b border-gray-200 sm:p-3 dark:border-gray-800">+ $24.00</td>
                      <td class="px-1 py-2 border-b border-gray-200 sm:p-3 dark:border-gray-800">
                        <div class="flex items-center">
                          <div class="flex-col hidden sm:flex">
                            01.04.2020
                ...
                <div class="flex justify-end w-full mt-5 space-x-2">
                  <button class="inline-flex items-center justify-center w-8 h-8 leading-none text-gray-400 border border-gray-200 rounded-md shadow dark:border-gray-800">
                    <svg class="w-4" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <polyline points="15 18 9 12 15 6"></polyline>
                    </svg>
                  </button>
                  <button class="inline-flex items-center justify-center w-8 h-8 leading-none text-gray-500 border border-gray-200 rounded-md shadow dark:border-gray-800">1</button>
                  <button class="inline-flex items-center justify-center w-8 h-8 leading-none text-gray-500 bg-gray-100 border border-gray-200 rounded-md shadow dark:border-gray-800 dark:bg-gray-800 dark:text-white">2</button>
                  <button class="inline-flex items-center justify-center w-8 h-8 leading-none text-gray-500 border border-gray-200 rounded-md shadow dark:border-gray-800">3</button>
                  <button class="inline-flex items-center justify-center w-8 h-8 leading-none text-gray-500 border border-gray-200 rounded-md shadow dark:border-gray-800">4</button>
                  <button class="inline-flex items-center justify-center w-8 h-8 leading-none text-gray-400 border border-gray-200 rounded-md shadow dark:border-gray-800">
                    <svg class="w-4" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <polyline points="9 18 15 12 9 6"></polyline>
                    </svg>
